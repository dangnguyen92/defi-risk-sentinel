...
const translations = {
  vi: {
    ...
    errorInvalidUrl: 'Một hoặc nhiều URL không hợp lệ. Vui lòng kiểm tra lại (URL phải bắt đầu bằng http:// hoặc https://).',
    invalidUrlLabel: 'URL không hợp lệ (phải bắt đầu bằng http:// hoặc https://)',
  ...
  en: {
    ...
    errorInvalidUrl: 'One or more URLs are invalid. Please check them (URLs must start with http:// or https://).',
    invalidUrlLabel: 'Invalid URL (must start with http:// or https://)',
